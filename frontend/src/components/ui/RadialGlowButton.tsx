...
/**
 * Radial-gradient glow button with rotating conic shine.
 * (User-provided effect, re-tinted to the deep-slate / gold palette.)
 */
  ...
  return (
    <div className="group relative inline-block">
      <style>{`
        ...
        @property --rg-color-1 { syntax: '<color>'; initial-value: #16182a; inherits: false; }
        @property --rg-color-2 { syntax: '<color>'; initial-value: #23273D; inherits: false; }
        @property --rg-color-3 { syntax: '<color>'; initial-value: #454C70; inherits: false; }
        @property --rg-color-4 { syntax: '<color>'; initial-value: #FFC800; inherits: false; }
        @property --rg-color-5 { syntax: '<color>'; initial-value: hsl(233 32% 6%); inherits: false; }
        @property --rg-border-angle { syntax: '<angle>'; initial-value: 180deg; inherits: true; }
        @property --rg-border-color-1 { syntax: '<color>'; initial-value: hsla(47, 100%, 80%, 0.7); inherits: true; }
        @property --rg-border-color-2 { syntax: '<color>'; initial-value: hsla(47, 60%, 70%, 0.25); inherits: true; }
        ...
        .rg-button:active { transform: scale(0.97); }
        ...
        .rg-button:hover {
          ...
          --rg-border-color-1: hsla(47, 100%, 80%, 0.15);
          --rg-border-color-2: hsla(47, 80%, 70%, 0.5);
